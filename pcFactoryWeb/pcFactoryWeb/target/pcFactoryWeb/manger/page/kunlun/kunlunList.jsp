			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-block" style="width: 200px;">
						<input type="text" name="name" placeholder="姓名/手机号"  autocomplete="off" class="layui-input">
					</div>						
				</div>
				<div class="layui-inline" style="margin-left: 35px;">	
					<button class="layui-btn btn_search" lay-submit lay-filter="quarry" id="the_Approved_search">查找</button>
